...
async function main() {
  ...
  console.log("\nEmployees:")
  console.log(
    "- John Smith (EMP001) - Password: john123 - Supervisor: Sarah Johnson"
  )
  console.log(
    "- Lisa Wong (EMP002) - Password: lisa123 - Supervisor: Sarah Johnson"
  )
  console.log(
    "- David Miller (EMP003) - Password: david123 - Supervisor: Michael Chen"
  )
  console.log(
    "- Jessica Brown (EMP004) - Password: jessica123 - Supervisor: Michael Chen"
  )
  console.log(
    "- Robert Taylor (EMP005) - Password: robert123 - Supervisor: Emily Rodriguez"
  )
  console.log(
    "- Amanda Davis (EMP006) - Password: amanda123 - Supervisor: Emily Rodriguez"
  )
  console.log(
    "- James Wilson (EMP007) - Password: james123 - Supervisor: Sarah Johnson"
  )
  console.log(
    "- Maria Garcia (EMP008) - Password: maria123 - Supervisor: Michael Chen"
  )
